...
OK, throw this into your @Gemfile@ (I'm specifying my own fork of the @rails3@ branch here, since I'm still waiting for it to get some improvements to the generators merged in and released). Also, I'll be using "Capybara":http://github.com/jnicklas/capybara for this example:

{% highlight ruby %}
group :test do
  gem 'steak',
    :git => 'git://github.com/jeffkreeftmeijer/steak.git',
    :branch => 'rails3'
  gem 'capybara'
end
{% endhighlight %}
