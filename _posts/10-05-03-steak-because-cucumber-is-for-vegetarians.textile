...
<img src="http://www.faqs.org/photo-dict/photofiles/list/1110/3610raw_steak.jpg" style="width:450px"/>
...
Right now the stable version of Steak only works with Rails 2.x and "RSpec":http://rspec.info/ 1.x, but there's a "Rails 3 branch":http://github.com/cavalle/steak/tree/rails3 where some work is being done to support Rails 3.x and RSpec 2.x. I've been using that one and had no problems whatsoever.
