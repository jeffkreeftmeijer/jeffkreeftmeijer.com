...
So, In my previous article I didn't consider installing gems from git or a local path. Right now, you _do_ need your .gemspec in your repository when you want your users to be able to do that. The problem of people touching your .gemspecs can -- to a certain extend -- be solved by not generating your .gemspec, but writing it yourself.
