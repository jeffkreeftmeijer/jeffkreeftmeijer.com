...
I started thinking about other solutions to the initial problem of people updating .gemspecs and wondered; &ldquo;Why are we putting our .gemspecs in our Rakefiles? Is the Rakefile really a place for gem information?
...
You dont _need_ a tool to generate a .gemspec for you, it's as simple as:
...
Gem::Specification.new do |gem|
  ...
  gem.homepage = 'http://github.com/user/mylib'
