...
{% highlight ruby %}
# `scenerio` is an alias for `it`, provided by Steak
...
{% highlight ruby %}
# `context` is an alias for `describe`, provided by Steak
