...
Back when Steak was first released, Capybara didn't have any of the nice RSpec helpers it does now. A lot has changed since. Besides the helpers, "it got its own RSpec DSL":https://github.com/jnicklas/capybara/commit/f4897f890d8dd33215fef238902988e8823a6539 recently, essentially eating Steak's functionality and turning it into a complete acceptance testing solution (on top of RSpec).
