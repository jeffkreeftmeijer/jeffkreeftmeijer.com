...
When going through Capybara's source, I found the @save_and_open_page@ method last week, which does a great job at fixing this issue. As the name implies: it saves the page -- complete with styling and images -- and opens it in your favorite browser:
