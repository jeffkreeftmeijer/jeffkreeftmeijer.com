...
While being static has a lot of advantages, it can be quite a pain sometimes. Since you don't have a database, you can't build a commenting system so your readers can comment on what you write, for example. Some other things are analytics and contact forms. Luckily, there are really nice solutions -- like "Disqus":http://discus.com, "Google analytics":http://google.com/analytics and "Wufoo":http://wufoo.com -- that allow you to simply implement these features using a simple javascript snippet.
...
"!/images/tapirgo.png!":http://tapirgo.com
...
bc. [
  {
      ...
      "content": [The whole article content],
...
Tapir will check your feed every fifteen minutes to see if there's anything new to index, but of course you can also ping
...
Over the last week we've been busy tweaking the search results and making the application more usable. We have a couple of plans to make Tapir more awesome, but we definitely need your help. If you start using Tapir, have a great idea or if you run into any issues, "@tapirgo(Tapir)":http://twitter.com/tapirgo would be glad to help.

While we built Tapir to search static sites, you can of course use it for anything that has an RSS feed. "@thedjinn(Emil Loer)":http://twitter.com/thedjinn created a "news search":http://emilloer.com/2011/05/04/searching-the-news-with-tapir/ that searches multiple feeds, like CNN and the Dutch NOS. If you end up doing something awesome we hadn't thought about before, be sure to let us know.
