...
I decided to spend a Monday to build a simple application that keeps a list of open source projects and makes it easy to give your own projects a state (maintained, looking for a new maintainer or abandoned). This way, each project gets a nice status page. Here's "Fuubar's":http://stillmaintained.com/jeffkreeftmeijer/fuubar.
