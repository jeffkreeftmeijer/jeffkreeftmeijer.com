...
This would be a good way for project owners to notify people they stopped supporting the project and will probably help them finding somebody that wants to start maintaining it. Also, it would become easier for users to find active projects instead of using code that nobody has worked on for months.

I've created a "feature request in Github's support forums":http://support.github.com/discussions/feature-requests/xxx to see if they would be willing to start implementing this. I would love to hear your opinion too, so what do you think?
