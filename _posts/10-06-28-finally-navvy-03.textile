...
!/images/steam_navvy.jpg(Navvy 0.3, codenamed &ldquo;Steam&rdquo;)!

I'm really excited to release "Navvy 0.3":http://rubygems.org/gems/navvy/versions/0.3.0 -- codenamed &ldquo;Steam&rdquo; -- and I think you're going to love it. It's "great, fantastic, amazing and magical":http://www.youtube.com/watch?v=Nx7v815bYUw and I'd like to highlight four &ldquo;tent poles&rdquo; for you today.

Ok, no more Apple marketing techniques. Promise.

h3. Mongoid

In adition to the adapters for "ActiveRecord":http://api.rubyonrails.org/classes/ActiveRecord/Base.html, "DataMapper":http://datamapper.org/, "Sequel":http://sequel.rubyforge.org/ and "MongoMapper":http://mongomapper.com, Navvy 0.3 intoduces a "Mongoid":http://mongoid.org/ adapter that works exactly like the rest. Special thanks to "@TomK32":http://twitter.com/TomK32 and "@rubenfonseca":http://twitter.com/rubenfonseca for helping out.
...
As I said in "my previous Navvy article":http://jeffkreeftmeijer.com/2010/daemonizing-navvy-with-god, I want to encourage users to use a process monitor (like "God":http://god.rubyforge.org/) since I believe handling background jobs is none of Navvy’s business. 
