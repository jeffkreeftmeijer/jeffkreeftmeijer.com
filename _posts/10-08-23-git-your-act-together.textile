...
"A note about Git commit messages":http://tbaggery.com/2008/04/19/a-note-about-git-commit-messages.html by "@tpope(Tim Pope)":http://twitter.com/tpope/ might be a good read if you think you need some guidelines.
...
Seriously. Just commit all the time. Don't wait until you go home, don't fix three _really_ simple bugs before committing, commit _every single change separately_.
...
If you replce the second occurance of &ldquo;pick&rdquo; with &ldquo;squash&rdquo; and save, another text editor pops up asking you to write a new commit message. After you saved that one, your commits will be merged into one, making your repository cleaner and allowing you to @git revert@ the whole thing at once.

If you want more information about rebasing, be sure to read "Squashing commits with Rebase":http://www.gitready.com/advanced/2009/02/10/squashing-commits-with-rebase.html on "Git Ready":http://www.gitready.com.
