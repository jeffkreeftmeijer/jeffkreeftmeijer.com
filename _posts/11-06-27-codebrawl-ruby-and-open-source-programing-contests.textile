---
layout: post
title: "Codebrawl: Ruby and open source programming contests"
excerpt:
published: true
---

Last week, I launched "Codebrawl":http://codebrawl.com, a code contest website focussed on Ruby programming and open source software.

!/images/codebrawl.png!
...
The contestants are always encouraged to keep working on their entries after the contest, to try to make sure others in the Ruby community benefit from what's created at Codebrawl.

Of course, we'll also do the occasional puzzle or give the contestants a specific task. This week, we're "introducing the contestants to ChunkyPNG":http://codebrawl.com/contests/pixelating-images-with-chunkypng, by letting them pixelate an image of a Tapir. I'm excited to see how this turns out and maybe we can even find something to contribute back to ChunkyPNG.
...
We're always looking for good contest ideas, so if you know something or have some open source project you'd like us to have a play with, please "submit it":http://localhost:3000/submissions/new. Also, we're looking for prize sponsors, so if you have some app credit you want to give out or some swag you want to send across the world, be sure to "let me know":jeffkreeftmeijer.com/contact.

If you have any comments, suggestions or ideas, please leave a comment below and be sure to participate in "this week's contest":http://codebrawl.com/contests/pixelizing-images-with-chunkypng.
