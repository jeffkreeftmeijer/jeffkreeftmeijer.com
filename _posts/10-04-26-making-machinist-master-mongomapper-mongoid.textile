...
machinist_mongo aims to support _all_ "mongoDB":http://www.mongodb.org/ ORMs, so If you're using something other than MongoMapper or Mongoid, please be sure to write a adapter for that too. Also, can anyone tell me why this isn't merged into Machinist itself? Because I think it should.
