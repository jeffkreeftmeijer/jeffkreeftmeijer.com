...
This week I want to take the time to tell you what ["Git":http://git-scm.com/]'s "reflog":http://www.kernel.org/pub/software/scm/git/docs/git-reflog.html and "bisect":http://www.kernel.org/pub/software/scm/git/docs/git-bisect.html do and give you a use-case for both so you know when you can actually _use_ them.

This might be old news for you, but I've come across a lot of people that use Git but never heard of them before or are afraid to use them because they're scary. In fact, they're not scary. They have the ability to save your ass and make you find bugs faster. _Awesome_.
